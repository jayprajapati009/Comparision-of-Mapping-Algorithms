...
img1 = cv.imread(
    r'C:\Users\jaypr\Desktop\Code\Python Codes\mapComparision\assets\hostelHectorslamUpdated.png', 0)
img2 = cv.imread(
    r'C:\Users\jaypr\Desktop\Code\Python Codes\mapComparision\assets\hostelCartographer.png', 0)
